...
mod_list = list(model0, model1)
rsme_table = data.frame(c("Base Model", "AIC model"), sapply(mod_list, get_train_rmse), sapply(mod_list, get_test_rmse), sapply(mod_list, get_r_squared))
